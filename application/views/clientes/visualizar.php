 ...
 *
 * Descricao:
 * Página criada para o conteúdo de Visualizar da Classe Clientes
 *
   ...
   <div class="card card-chart">
    <div class="card-header">
      ...
      <div class="card">
       <div class="card-body">
        <form>
         <input type="hidden" id="idCliente" name="idCliente" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->idCliente; ?> "disabled="">
         ...
         <div class="row">
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="razaoSocial" name="razaoSocial" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->razaoSocial; ?>" class="form-control" placeholder="Preencha o nome completo da Razao Social"  disabled="">
           </div> </div>

          <div class="col-md-4">
           <div class="form-group">
            <label for="cnpj" style="color:#ff8379;">CNPJ:</label>
            <input type="text" id="cnpj" name="cnpj" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->cnpj; ?>" class="form-control" placeholder="Preencha sem pontos e sem a barra! ex:1234567890001" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="nomeFantasia" name="nomeFantasia" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->nomeFantasia; ?>" class="form-control" placeholder="Preencha o Nome Completo do Cliente" disabled="">
           </div>  
          </div>
         </div>
         <hr>
         ...
         <div class="row">
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="contatoDaEmpresa" name="contatoDaEmpresa" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->contatoDaEmpresa; ?>" class="form-control" placeholder="Nome do Contato Responsável da Empresa" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="telefoneDoContato" name="telefoneDoContato" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->telefoneDoContato; ?>" class="form-control" placeholder="Telefone do Contato Responsável da Empresa" disabled="">
           </div>  
          </div>
          ...
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="emailDoContato" name="emailDoContato" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->emailDoContato; ?>" class="form-control" placeholder="Email do Contato Responsável da Empresa" disabled="">
           </div> 
          </div>
         </div>
         <hr>
         ...
         <div class="row">
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="telefone" name="telefone" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->telefone; ?>" class="form-control" placeholder="Preencha o Número do Telefone Principal da Empresa" disabled="">
           </div> 
          </div>
          ...
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="site" name="site" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->site; ?>" class="form-control" placeholder="Se Houver um Celular ou Telefone Fixa de Contato da Empresa" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-4">
           <div class="form-group">
            ...
            <input type="text" id="email" name="email" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->email; ?>" class="form-control" placeholder="Se Houver um Endereço de Email da Empresa" disabled="">
           </div> 
          </div>
         </div>
         <hr>
         ...
         <div class="row">
          <div class="col-md-2">
           <div class="form-group">
            ...
            <input type="text" id="cep" name="cep" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->cep; ?>" class="form-control" placeholder="Sem espaços ou traços" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-3">
           <div class="form-group">
            ...
            <input type="text" id="rua" name="rua" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->rua; ?>" class="form-control" placeholder="Cadastre a Rua do Cliente" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-1">
           <div class="form-group">
            ...
            <input type="text" id="numero" name="numero" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->numero; ?>" class="form-control" placeholder="Numero da Fachada" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-2">
           <div class="form-group">
            ...
            <input type="text" id="bairro" name="bairro" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->bairro; ?>" class="form-control" placeholder="Bairro da Empresa" disabled="">
           </div>
          </div>
          ...
          <div class="col-md-2">
           <div class="form-group">
            ...
            <input type="text" id="cidade" name="cidade" style="color:orange; border-color:#5282b2" value="<?= $cliente[0]->cidade; ?>" class="form-control" placeholder="Cidade da Empresa" disabled="">
           </div>
          </div>

          <div class="col-md-2">
           <label for="estado" style="color:#ff8379;">Estado:</label>
           <select id="estado" name="estado" style="color:orange; border-color:#5282b2" class="browser-default custom-select custom-select-md mb-3" disabled="">
         ...
         <div class="row">
          <div class="col-md-4">
           ...
           <select style="color:orange; border-color:#5282b2" id="situacaoDoContrato" name="situacaoDoContrato" class="browser-default custom-select custom-select-md mb-3" disabled="">
            <option style="color:orange; border-color:#5282b2;" value="0" <?= $cliente[0]->situacaoDoContrato==0?'selected':''; ?>>NÃO, POSSUÍ CONTRATO!</option>
            <option style="color:orange; border-color:#5282b2;" value="1" <?= $cliente[0]->situacaoDoContrato==1?'selected':''; ?>>SIM, POSSUÍ CONTRATO!</option>
           </select>
          </div>
         </div>
         <div class="row">
