   ...
   <div class="card card-chart">
    <div class="card-header">
     ...
     <div class="col-sm-10 text-left">
      <h2 class="card-title">Atualizar Filiais</h2>
      <h4 style="color:#00dccd;">Mantenha sempre os dados das Filiais atualizados!</h4>
     </div>
     <div class="card">
      <div class="card-body">
       <form action="<?= base_url('Filiais/editando') ?>" method="post">
        ...
        <div class="row">
         <div class="col-md-2">
          <div class="form-group">
           ...
           <input style="border-color:#5282b2" type="text" id="nomeFilial" name="nomeFilial" value="<?= $filial[0]->nomeFilial ?>" class="form-control" placeholder="Insira o nome da Nova Filial" required>
          </div>
         </div>
        ...
        <div class="row">
         <div class="col-md-8">
          <div class="form-group">
           ...
           <input style="border-color:#5282b2" type="text" id="descricaoFilial" name="descricaoFilial" value="<?= $filial[0]->descricaoFilial ?>" class="form-control" placeholder="Descreva o Serviço" required>
          </div>  
         </div>
        </div>
